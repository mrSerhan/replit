...
public class replit138_StoreProduct {
	...
	int stock;
		...
		public replit138_StoreProduct(String label, double price, String category, boolean hasExpiration, int stock ) {
			this.label = label;
			this.price = price;
		...
		public replit138_StoreProduct(String label, double price, int stock ) {
			this.label = label;
			this.price = price;
			this.category = "misc";
		...
		public replit138_StoreProduct(String label, double price) {
			this.label = label;
			this.price = price;			
			this.stock = 0;
		}
